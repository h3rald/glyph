...
Think of it like a sort of =>[http://www.rubyonrails.org|Ruby on Rails] but for creating text documents instead of web sites. With Glyph, you can manage your documents tidily in _projects_ that can be used to generate deliverables in different formats such as HTML or PDF (through =>[http://www.princexml.com|Prince]).
...
@sudo gem install glyph@ -- simple, as always.
...
* Project Home Page: =>[http://www.h3rald.com/glyph/]
* Source Code Repository & Bug Tracking: =>[http://www.github.com/h3rald/glyph/]
* Book (PDF): =>[http://github.com/h3rald/glyph/tree/master/book/output/pdf/glyph.pdf]
