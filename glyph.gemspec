...
Gem::Specification.new do |s|
  ...
  s.files = [
    "README.textile",
     ...
     "config.yml",
     "document.glyph",
     "extras/handbook/config.yml",
     "extras/handbook/document.glyph",
     "extras/handbook/output/html/glyph_handbook.html",
     "extras/handbook/snippets.yml",
     "extras/handbook/styles/default.css",
     "extras/handbook/text/glyph_language.textile",
     "extras/handbook/text/introduction.textile",
     "extras/sequence_diagram.png",
     "extras/sequence_diagram.txt",
     "glyph.gemspec",
     "lib/glyph.rb",
