...
<table><tr><th>ID</th>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/120">#120</a></td>
		<td><p>It is now possible to compile your project to a single HTML5 file (<em>html5</em> output) or multiple files (<em>web5</em> output)</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/142">#142</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>navigation macros</span></p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/148">#148</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>customization enhancements</span></p></td></tr></table>

</div>
	
	
		<div class="section">
<h3 id="h_3">13 Bugs Fixed</h3>
<table><tr><th>ID</th>
					<th>Description</th></tr>
				
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/133">#133</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>html charset</span></p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/136">#136</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>utils module refactoring</span></p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/139">#139</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>configuration refactoring</span></p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/140">#140</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>macro helpers</span></p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/141">#141</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>non-rb files loaded with macros</span></p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/145">#145</a></td>
		<td><p><span class="todo"><span class="todo-pre"><strong><span class="caps">TODO</span>:</strong> </span>bundler conflicts</span></p></td></tr></table>
...
<div class="section">
<h3 id="h_5">27 Features Implemented</h3>
<table><tr><th>ID</th>
					<th>Description</th></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/130">#130</a></td>
		...
		<div class="section">
<h3 id="h_6">7 Bugs Fixed</h3>
<table><tr><th>ID</th>
					<th>Description</th></tr>
				
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/109">#109</a></td>
		<td><p>Performance has been dramatically improved by implementing a parser from scratch (see <a href="#new_parser"></a>)</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/122">#122</a></td>
		<td><p>Macro encoding/decoding no longer necessary due to the new parser (see <a href="#new_parser"></a>)</p></td></tr>
...
<div class="section">
<h3 id="h_8">23 Features Implemented</h3>
<table><tr><th>ID</th>
					<th>Description</th></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/100">#100</a></td>
		<td><p><a id="system_css"></a>Glyph <span class="caps">CSS</span> files are no longer copied to new projects, but they can be referenced as if they were (see also <a href="#css_not_copied"></a>).</p></td></tr>
...
<table><tr><th>ID</th>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/93">#93</a></td>
		<td><p><a id="css_not_copied"></a>Default css files were not copied when creating a new project. The issue has been resolved by allowing the style macro to reference Glyph&#8217;s system styles (see also <a href="#system_css"></a>).</p></td></tr>
