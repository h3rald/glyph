...
<table><tr><th>ID</th>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/39">#39</a></td>
		<td><p>A new  command is available to display the document outline.</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/111">#111</a></td>
		<td><p>System settings are now stored within a <code>system.*</code> namespace and cannot be changed via the  macro or the  command.</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/124">#124</a></td>
		<td><p>Implemented new  macro and  macro.</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/126">#126</a></td>
		<td><p>A new  macro has been implemented to create simple macros using just Glyph code.</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/127">#127</a></td>
		<td><p>A new  macro has been implemented to create macro aliases.</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/128">#128</a></td>
		<td><p>A blacklist for <span class="caps">XML</span> tags has been exposed via the  setting.</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/129">#129</a></td>
		<td><p>The  macro can now be used in lite mode, it can evaluate ruby files and requires relative paths.</p></td></tr>
...
<table><tr><th>ID</th>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/62">#62</a></td>
		<td><p>A new  macro is available to highlight source code (CodeRay or UltraViolet required).</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/87">#87</a></td>
		<td><p>It is now possible to define snippets inside a Glyph source file using the  macro.</p></td></tr>	
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/88">#88</a></td>
		<td><p>It is now possible to change configuration settings inside a Glyph source file using the  macro (Jabbslad).</p></td></tr>	
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/92">#92</a></td>
		<td><p>6 new macros have been defined to allow conditional processing ( macro,  macro,  macro,  macro,  macro,  macro)</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/97">#97</a></td>
		<td><p>The  command command can now take an extra <code>--auto</code> switch to trigger document auto-regeneration whenever a source file is changed (koraktor).</p></td></tr>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/108">#108</a></td>
		<td><p>It is now possible to define Glyph macros within Glyph source files using the  macro.</p></td></tr></table>
...
<table><tr><th>ID</th>
	...
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/93">#93</a></td>
		<td><p><a id="css_not_copied"></a>Default css files were not copied when creating a new project. The issue has been resolved by allowing the  macro to reference Glyph&#8217;s system styles (see also <a href="#system_css">#100</a>).</p></td></tr>
		
	<tr><td><a href="http://github.com/h3rald/glyph/issues/closed#issue/95">#95</a></td>
		<td><p>The  command did not save data to <span class="caps">YAML</span> configuration files. This has been fixed ensuring that internal configuration overrides are not saved to the <span class="caps">YAML</span> file too.</p></td></tr>
